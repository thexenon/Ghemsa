...
class LabWorksActivity : AppCompatActivity() {
    ...
    internal var URL = "https://drive.google.com/drive/folders/1kbJSCjUe-RSpzJswHzp7QSg1BjOM1kWE"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_lab_works)

        AppCompatDelegate.setCompatVectorFromResourcesEnabled(true)

        mContext = this
        mWebView = findViewById<View>(R.id.labworkswebview) as WebView
    ...
    private fun requestWebView() {
        ...
        mWebView.webChromeClient = object : WebChromeClient() {
            override fun onShowFileChooser(
                ...
                if (takePictureIntent!!.resolveActivity(this@LabWorksActivity.packageManager) != null) {
