...
class PastQuesActivity : AppCompatActivity() {
    ...
    internal var URL = "https://drive.google.com/drive/folders/1_EF3jIWR0GKgAwaDyxEh4Vl3goAPTQyP"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_past_ques)

        AppCompatDelegate.setCompatVectorFromResourcesEnabled(true)

        mContext = this
        mWebView = findViewById<View>(R.id.pastqueswebview) as WebView
    ...
    private fun requestWebView() {
        ...
        mWebView.webChromeClient = object : WebChromeClient() {
            override fun onShowFileChooser(
                ...
                if (takePictureIntent!!.resolveActivity(this@PastQuesActivity.packageManager) != null) {
