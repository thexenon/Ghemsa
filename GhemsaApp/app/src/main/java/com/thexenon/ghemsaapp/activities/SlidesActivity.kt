...
class SlidesActivity : AppCompatActivity() {
    ...
    internal var URL = "https://drive.google.com/drive/folders/1ect9tsntxJNNTLleKI870b8EhqsMwHew"
    ...
    private fun requestWebView() {
        ...
        mWebView.webChromeClient = object : WebChromeClient() {
            override fun onShowFileChooser(
                ...
                if (takePictureIntent!!.resolveActivity(this@SlidesActivity.packageManager) != null) {
